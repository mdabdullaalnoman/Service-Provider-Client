      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav navbar_items">
          <Nav className="ms-auto header_link d-flex justify-content-center align-items-center">
            <Nav.Link href="#home"><h6 >Publish a project</h6></Nav.Link>
            <Nav.Link href="#link"><h6>Login</h6></Nav.Link>
            <Nav.Link href="#link" className="active register"> <button>Register as a professional</button></Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
